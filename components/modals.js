...
export default function Modal(props){
  ...
  "
      ...
      "
          ...
          justify-between
          p-5
          border-b border-solid border-blue-200
          rounded-t
        "
                        >
            ...
            <i className="fas fa-times"></i>
                        ...
                        <div className="relative p-6 flex-auto">
                            ...
                            </p>
                            {
                                ...
                                }} className={"h-20 p-2 flex w-full border border-blue-400 text-gray-600"}/>
                            }
          ...
          justify-end
          p-6
          border-t border-solid border-blue-200
          rounded-b
        "
                        >
                            {
          ...
          "
                                    type="button"
                                    onClick={()=>{props.button2Action && props.button2Action(text)}}
                                >
                                    {props.button2Text}
                                </button>
                            }
